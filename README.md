...
<ol type = "I">
   <li style="font-size:25px;">진행 전략</li>
...
1-2) VSCode 설치: <https://code.visualstudio.com></br>
1-3) Python VSCode Extension 설치: <https://marketplace.visualstudio.com/items?itemName=ms-python.python></br>
...
## 3. 사용 프로그램
<li style="font-size:18px; font-weight:450;">Python 편집</li>
...
<li style="font-size:18px; font-weight:450;">파일 전송</li>
...
<li style="font-size:18px; font-weight:450;">Raspberry Pi 통신</li>
...
## __5. 트랙 제작__
* <b style="font-size:18px; font-weight:450;">대회 트랙 규격</b>
...
* <b style="font-size:18px; font-weight:450;">트랙 제작</b>
...
# II. 알고리즘 
<img src="https://user-images.githubusercontent.com/82248453/125550287-a44599f5-6108-4ab7-be09-8081f2e7577a.png" width="500" height="600">
</br>
</br>
</br>

* <b style="font-size:18px; font-weight:450;">트랙 분석</b>
...
a) 링과의 거리에 따라 직진 거리 조절

b) 특정 지점에서 드론 위치 조정

c) 링 통과 후 색깔 판단

d) 판단한 색에 따라 드론 동작</br></br></br>

* <b style="font-size:18px; font-weight:450;">이미지에 따른 모드 분류</b>
...
* <b style="font-size:18px; font-weight:450;">알고리즘 종합</b>
...
# III. 사용 코드
* <b style="font-size:18px; font-weight:450;">대회 사용 모듈</b>
...
* <b style="font-size:18px; font-weight:450;">코드</b>
